...
<tileset version="1.4" tiledversion="1.4.3" name="animated" tilewidth="32" tileheight="32" tilecount="14" columns="14">
 <image source="water_waves_32x32.png" width="448" height="32"/>
 <tile id="0">
  <animation>
